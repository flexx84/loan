...
import { Building2, CreditCard, Briefcase, Home, CheckCircle, ArrowRight } from 'lucide-react';
...
const ServiceSection = () => {
  ...
  const advantages = [
    {
      title: '전국 300+ 금융사 비교',
      description: '은행, 저축은행, 캐피탈 등 모든 금융기관의 상품을 한 번에 비교분석',
      icon: '🏦'
    },
    {
      title: '개인 맞춤형 추천',
      description: '고객의 신용점수, 소득, 재직기간 등을 종합 분석하여 최적 상품 추천',
      icon: '🎯'
    },
    {
      title: '24시간 신속 처리',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            신용대출부터 부동산담보대출까지 당신에게 가장 유리한 조건을 찾아드립니다
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {loanTypes.map((loan, index) => {
            ...
            return (
              ...
              >
                <div className={`w-12 h-12 rounded-xl ${getColorClasses(loan.color)} flex items-center justify-center mb-4`}>
